...
theme can render. Two ship with this project:

- `Lyra.Commerce` — products, prices, and inventory, with an admin CRUD screen under Commerce →
  Products, and a storefront widget any theme can place on a page.
...
See `docs/multi-tenancy.md` for the walkthrough.
